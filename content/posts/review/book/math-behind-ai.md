...
<img src="/assets/posts/ai-math-behind-ai-cover.webp" alt="AI를 움직이는 수학 이야기 표지" style="width:min(420px,100%);height:auto;display:block;margin:1.5rem auto;" loading="lazy" decoding="async" />
...
<img src="/assets/posts/ai-math-recommendation-matrix.png" alt="추천 시스템을 벡터와 평가 행렬로 설명하는 도식" style="width:min(600px,100%);height:auto;display:block;margin:1.5rem auto;" loading="lazy" decoding="async" />

## 좋았던 점 2: LLM만 파지 않고 전체 지형을 보여준다

요즘은 LLM 중심으로만 설명하는 책이 많다. 그런데 이 책은 검색, 추천, 비전, 음성, GPS까지 엮어서 보여준다.

<img src="/assets/posts/ai-math-transformer-softmax.png" alt="트랜스포머의 출력 확률과 소프트맥스를 설명하는 도식" style="width:min(760px,100%);height:auto;display:block;margin:1.5rem auto;" loading="lazy" decoding="async" />
